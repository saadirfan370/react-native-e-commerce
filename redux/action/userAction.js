  ...
  try {
      const { data } = await axios.get("http://192.168.100.34:3000/api/user/me", {
        headers: {
          ...
          cookies:
            "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY0YmNlMzE1Nzk0ZWVlNTJiNzk4YTBiMSIsImlhdCI6MTY5MDI3MTQ5MSwiZXhwIjoxNjkwMjc1MDkxfQ.FvNwAbMlBNpfuktwkKKL-EkVlODIGx-zgmxEacFUBGw", // Include the token in the cookies
        },
      });
      dispatch({
